Getting started with React. Creating a movies catalog using The Movie DB API. Thanks to [CodeCamps](https://www.codecamps.com/) for this fantastic [course](https://sweetpumpkins.codecamps.com/).  
